  ...
  deleteUser(id:number){
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.toastr.success("Utilisateur supprimé avec succés",'Suppression avec succés!');
    ...
    this.userService.getAllUsers().subscribe(users=>{
        ...
        datatable.DataTable({
          ...
          columns: [
            ...
            { title: 'CIN', data: 'cin' },
            { title: 'Num Tel', data: 'phoneNumber' },
            {
              title: 'Actions',
              render: function (data: any, type: any, full: any) {
               ...
               <div style="  display: flex;justify-content: center;">
                ...
                <button type="button" class="btn btn-primary mr-2" data-id="${full.id}">
